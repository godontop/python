    ...
    def __call__(self, url, html):
        if url == self.seed_url:
            ...
            bad_urls = ['livedoor.biz', 'vkuseraudio.net',
                        ...
                        'cnzz.com', 'v2ex.com', 'td.com', 'prothomalo.com', 'free.fr',
                        'neobux.com', 'jma.go.jp', 'lee.tmall.com', 'bamilo.com',
                        'feng.com', 'tomsguide.com', 'aimer.tmall.com', 'velocecdn.com',
                        'newsupdateset.info', 'stanford.edu', '51cto.com', 'ethfw0370q.com']
